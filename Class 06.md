OSI model demonstrates how computers communicate with each other. The data link layer transfers data on a physical level, using mac addresses. It's separated by the MAC sub layer
